...
export async function generatePRDescription(
        ...
        let title = "Architect Loop Session Changes";
...
${problemStatement ? `**Problem:** ${problemStatement.split('\n')[0]}` : 'Automated changes from Architect Loop session.'}
...
🥒 Generated by [Pro Rick Opus 46 CLI](https://github.com/galz10/pro-rick-opus46-extension)
