...
async function main() {
    ...
    console.log(JSON.stringify({
        decision: 'allow',
        systemMessage: "You are a senior autonomous architect. Communicate concisely and technically. Prioritize quality-first engineering and autonomous problem-solving.",
    }));
}
